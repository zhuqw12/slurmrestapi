...
func NewV0039JobDescMsg() *V0039JobDescMsg {
...
func (o *V0039JobDescMsg) HasEnvironment() bool {
	if o != nil && !IsNil(o.Environment) {
		return true
	}
...
func (o *V0039JobDescMsg) GetPriority() int32 {
...
// and a boolean to check if the value has been set.
func (o *V0039JobDescMsg) GetPriorityOk() (*int32, bool) {
	if o == nil || IsNil(o.Priority) {
		return nil, false
	}
...
func (o *V0039JobDescMsg) SetPriority(v int32) {
	o.Priority = &v
}
