...
type Dbv0037AssociationMaxTresGroup struct {
	...
	Minutes []Dbv0038TresListInner `json:"minutes,omitempty"`
	// TRES list of attributes
	Active []Dbv0038TresListInner `json:"active,omitempty"`
}
...
// SetMinutes gets a reference to the given []Dbv0038TresListInner and assigns it to the Minutes field.
...
// SetActive gets a reference to the given []Dbv0038TresListInner and assigns it to the Active field.
