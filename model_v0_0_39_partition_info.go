...
type V0039PartitionInfo struct {
	...
	Cpus        *V0039PartitionInfoNodes    `json:"cpus,omitempty"`
...
func (o *V0039PartitionInfo) GetCpus() V0039PartitionInfoNodes {
...
// and a boolean to check if the value has been set.
func (o *V0039PartitionInfo) GetCpusOk() (*V0039PartitionInfoNodes, bool) {
	if o == nil || IsNil(o.Cpus) {
		return nil, false
	}
	return o.Cpus, true
...
// SetCpus gets a reference to the given V0039PartitionInfoNodes and assigns it to the Cpus field.
func (o *V0039PartitionInfo) SetCpus(v V0039PartitionInfoNodes) {
	o.Cpus = &v
}
