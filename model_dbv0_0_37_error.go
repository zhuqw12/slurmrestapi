...
// checks if the Dbv0037Error type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dbv0037Error{}
...
func (o Dbv0037Error) ToMap() (map[string]interface{}, error) {
